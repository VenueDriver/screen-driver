...
describe('Service: SchedulesService', () => {
    ...
    beforeEach(inject([SchedulesService, ApiService, SettingsPriorityHelper, SettingsService, SettingStateHolderService, NotificationService, NotificationsService],
        (schedulesService, apiService, settingsPriorityHelper, settingsService, settingStateHolderService, notificationService, notificationsService) => {
            this.schedulesService = schedulesService;
            this.apiService = apiService;
            this.settingsPriorityHelper = settingsPriorityHelper;
    ...
    describe('createSchedule()', () => {
        ...
        describe('when called with undefined setting and eventTimeHolder', () => {
            it('save method should be called', () => {
                ...
                expect(this.schedulesService.save).toHaveBeenCalledWith(expectedSchedule, undefined);
            });
        });
        ...
        describe('when called with setting and eventTimeHolder', () => {
            it('save method should be called with schedule contained setting id', () => {
                ...
                expect(this.schedulesService.save).toHaveBeenCalledWith(expectedSchedule, setting);
            });
