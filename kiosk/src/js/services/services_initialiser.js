...
class ServicesInitialiser {
    ...
    static initBaseServices() {
        ...
        require('./error-handlers/global_errors_handling_service');
        require('./error-handlers/network_errors_handling_service');
        require('./error-handlers/uncaught_errors_handling_service');
